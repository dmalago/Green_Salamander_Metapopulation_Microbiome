...
#Define violin plot
p_jaccard_overall<-c()
p_jaccard_overall <- ggplot(diversity_df, aes(x = reorder(type, jaccard_overall), y=jaccard_overall)) + geom_violin(aes(fill=type),width = 1.5) 
#Choose the size of font for the axes titles and labels
p_jaccard_overall<-p_jaccard_overall+theme(axis.title = element_text(size = 25))+theme(axis.text = element_text(size = 15))
#Choose the size of font for the legend title and lables
p_jaccard_overall<-p_jaccard_overall+theme(legend.title = element_text(size = 20))+theme(legend.text = element_text(size = 15))
#Choose the violin colors for each group
p_jaccard_overall<-p_jaccard_overall+scale_fill_manual(values=c('yellow','brown','red','blue','green','grey','orange',"purple"))
#Add boxplots inside the violins
p_jaccard_overall<-p_jaccard_overall+geom_boxplot(aes(fill=type),width=0.1)+geom_point(position = position_jitter(seed = 1, width = 0.1)) +theme_linedraw()+theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+theme(text = element_text(size=25))
p_jaccard_overall<-p_jaccard_overall + labs(x = "Population")
p_jaccard_overall<-p_jaccard_overall + labs(fill = "Population")
p_jaccard_overall<-p_jaccard_overall + labs(y = "Jaccard")+theme(text = element_text(size=25))
...
#Choose the size of font for the axes titles and labels
p_jaccard_overall_phy<-p_jaccard_overall_phy+theme(axis.title = element_text(size = 25))+theme(axis.text = element_text(size = 15))
#Choose the size of font for the legend title and lables
...
#Choose the violin colors for each group
p_jaccard_overall_phy<-p_jaccard_overall_phy+scale_fill_manual(values=c('yellow','brown','red','blue','green','grey','orange',"purple"))
#Add boxplots inside the violins
p_jaccard_overall_phy<-p_jaccard_overall_phy+geom_boxplot(aes(fill=type),width=0.1)+geom_point(position = position_jitter(seed = 1, width = 0.1, )) +theme_classic()
#Add the p-value for the Kruskal-Wallis test somewhere on your figure (you may have to change the x and y positions of this label)
p_jaccard_overall_phy<-p_jaccard_overall_phy + labs(x = "Population")
p_jaccard_overall_phy<-p_jaccard_overall_phy + labs(fill = "Population")
p_jaccard_overall_phy<-p_jaccard_overall_phy + labs(y = "Unifrac")+theme(text = element_text(size=25))+theme_linedraw()+theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+theme(text = element_text(size=25))

#Make your plot
p_jaccard_overall_phy 
...
#Choose the violin colors for each group
p_bray_overall<-p_bray_overall+scale_fill_manual(values=c('yellow','brown','red','blue','green','grey','orange',"purple"))
#Add boxplots inside the violins
p_bray_overall<-p_bray_overall+geom_boxplot(aes(fill=type),width=0.1)+geom_point(position = position_jitter(seed = 1, width = 0.1, )) +theme_classic()
p_bray_overall<-p_bray_overall + labs(x = "Population")
p_bray_overall<-p_bray_overall + labs(fill = "Population")
p_bray_overall<-p_bray_overall + labs(y = "Bray-Curtis")+theme(text = element_text(size=25))+theme_linedraw()+theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())+theme(text = element_text(size=25))
...
########SI Figure 8, ########
pdf(file = "SI_Figure_8.pdf", width = 27, height = 8)
p_jaccard_overall + p_jaccard_overall_phy + p_bray_overall  
dev.off()
